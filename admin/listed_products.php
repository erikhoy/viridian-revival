                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php foreach($products as $product): ?>
                                ...
                                <?php $image = Image::find_image_by_product_id($product->id); print_r($image);echo "<br>"; ?>
                                <?php $bin_id = 1; ?>
                                <?php if(!empty($product->bin_id)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <a href="sell_product.php?id=<?php echo $product->id; ?>">Sell</a>
                                        <br>
