...
<div class="row">
  ...
  <div class="row">
    <div class="col col-xs-offset-1 col-xs-10 col-md-offset-1 col-md-4">
      <h2>Welcome to Viridian Revival!</h2>
      <p>Above is a random sampling of some of the items that we are currently selling or have already sold at our <a href="https://www.etsy.com/shop/ViridianRevival" target='_blank'>Etsy store</a>. Click to see which <a href="<?php echo ROOT_PATH.DS.'products'.DS.'listed_products.php'; ?>">listings</a> are still available.</p>
      <p><a href="<?php echo ROOT_PATH.DS.'contact.php'; ?>">Contact us</a> if you have any questions or are interested in purchasing any of the items available.</p>
      <h2>About Us</h2>
      <p><img src="../viridian_revival/admin/images/strongman.jpg" alt="Strongman toy" width="20%" align="right">People’s trash fascinates us. We have spent many hours alley shopping and dumpster diving, finding things that aren’t quite ready for the landfill. We find vintage chairs to paint and reupholster, industrial or mechanical items become lighting, and found wood becomes Adirondack chairs, sofas, tables, benches or other furniture.</p>
    ...
    <div class="recent col col-xs-offset-1 col-xs-10 col-md-6">
            ...
            <div class="col col-md-3">
              ...
              <div class="clearfix">
                <?php for($i=0; $i<$review->stars; $i++) { ?>
                  <span id="toggle" class="glyphicon glyphicon-star"></span>
                <?php } ?>
                <?php for($i=0; $i<(5-$review->stars); $i++) { ?>
                  <span id="toggle" class="glyphicon glyphicon-star-empty"></span>
                <?php } ?>
              </div>
            </div>
